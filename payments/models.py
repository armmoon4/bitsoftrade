...
class PaymentTransaction(models.Model):
    ...
    card_key            = models.CharField(max_length=30, blank=True, default='', help_text='CMS PricingPlan card_key')
    ...
    def __str__(self):
        return f"{self.user.email} – {self.plan_type} – {self.billing_cycle} – {self.status} – ₹{self.amount}"